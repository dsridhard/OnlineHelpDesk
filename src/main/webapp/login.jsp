...
<body>
	...
	<div class="container d-flex justify-content-center">
		<div class="login-card text-center">
			...
			<p class="text-muted small mb-4">Welcome back! Please enter your
				details.</p>
			...
			<div
				...
				<div class="d-flex align-items-center justify-content-center">
					<i class="fa-solid fa-circle-check me-2"></i> <small>Registration
						successful! Please login.</small>
				</div>
			...
			<%-- Alert Handling: Shows Logout or Error messages --%>
			<div id="alertContainer">
				...
				<div
					...
					role="alert">
					<div class="d-flex align-items-center justify-content-center">
						<i class="fa-solid fa-circle-info me-2"></i> <small>Logged
							out successfully.</small>
					</div>
					<button type="button" class="btn-close" data-bs-dismiss="alert"
						aria-label="Close"></button>
				</div>
				...
				<div
					...
					role="alert">
					<div class="d-flex align-items-center justify-content-center">
						<i class="fa-solid fa-circle-exclamation me-2"></i> <small><strong>Wrong
								Credentials!</strong> Try again.</small>
					</div>
					<button type="button" class="btn-close" data-bs-dismiss="alert"
						aria-label="Close"></button>
				</div>
			...
			<form action="LoginServlet" method="post">
				<div class="mb-3 text-start">
					<label for="userID" class="form-label fw-semibold small">User
						ID</label>
					<div class="input-group">
						<span class="input-group-text bg-light border-end-0"> <i
							class="fa-solid fa-id-badge text-muted"></i>
				...
				<div class="mb-4 text-start">
					...
					<div class="input-group">
						<span class="input-group-text bg-light border-end-0"> <i
							class="fa-solid fa-lock text-muted"></i>
						</span> <input type="password" class="form-control border-start-0"
				...
				<div class="mt-4 border-top pt-3">
					...
					<a href="registration.jsp" class="text-decoration-none fw-bold">Register
						Now</a>
				</div>
